...
<template>
  <div ref="box" @click="onDrop" class="h-[64px] relative overflow-hidden border " @drop="onDrop"
    @dragend="dragEnd" @dragenter.prevent @dragover.prevent>
    ...
    <div v-else class="flex justify-center items-center h-full w-100  group/plus ">
